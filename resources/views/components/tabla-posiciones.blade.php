<table class="bg-(--color-bg-body) border-collapse min-w-[80%] whitespace-nowrap mx-auto font-(--fuente-primaria) table-fixed">
    <thead>
        <tr class="bg-(--color-primario) text-(--color-letras-secundario) text-[0.9rem] md:text-base lg:text-[1.1rem] font-bold">
            <th class="w-32 border-l-4 border-(--color-primario) py-3 px-2 text-center">Pos</th>
            <th class="w-72 lg:w-auto py-3 px-2 pl-4 text-left sticky left-0 z-3 bg-(--color-primario) lg:static">Equipo</th>
